        ...
        <div className="hero min-h-screen  md:bg-fixed" style={{ backgroundImage: 'url(images/bgImages/b1.jpg)' }}>
            ...
            <div className="hero-content text-center text-neutral-content">
                <div className="max-w-lg">
                    ...
                    <p className="mb-5">Lorem, ipsum dolor sit amet consectetur adipisicing elit. Corporis fuga corrupti at commodi ducimus necessitatibus architecto laboriosam reiciendis maiores dolorem!</p>
