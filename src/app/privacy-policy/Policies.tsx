...
const privacyPolicy: PrivacyPolicyItem[] = [
    {
        ...
        mainDescription: [
            "The following information is collected by or on behalf of Multiply",
        ],
        sub: [
            {
            ...
            },
            {
                ...
                description: [
                    ...
                    "On the Android app, Multiply requires access to additional information such as SMS. Prior to accessing any such information, explicit consent shall be sought from the User. Please note that we only read transactional or promotional SMS and do not open, access or read any personal SMS.",
        ...
        sub: [
            {
                ...
                description: [
                    "Any information provided by a User will be used solely for creating and updating your Account and processing your transaction(s) or for any other purposes for which you have granted access to such information to us, based on your interaction with the Multiply website/app.",
    ...
    },
    {
        ...
        mainDescription: [
            ...
            "Users also have the option to request for an account deactivation instead. This will temporarily block user access to Multiply until they send a re-activation request on support@multiply.club and successfully re-activate their account."
        ]
    },
    {
        mainTitle: "Cookies",
        mainDescription: [
            "We use data collection devices such as “cookies”, etc. on certain parts of the Web to help analyze the Web Services, user interaction with the Web, measure promotional effectiveness, and promote trust and safety. For the sake of clarity, “cookies” are small files placed on your device hard-drive/storage that assist us in providing the Web Services. Please be informed that Multiply offers certain features via the Web that are only available through the use of a “cookie”.",
    ...
    },
    {
        ...
        mainDescription: [
            "Multiply's use of information received from Google APIs will adhere to Google API Services User Data Policy, including the Limited Use requirements."
        ]
    },
    {
        mainTitle: "Changes to Privacy Policy",
        mainDescription: [
            "Multiply reserves the right to change this policy from time to time. Any changes shall be effective immediately upon the posting of the revised Privacy Policy. We encourage you to periodically review this page for latest information on our privacy practices."
        ]
    },
    {
        mainTitle: "Privacy Questions and Access",
        mainDescription: [
            "If you have questions, concerns, or suggestions regarding our Privacy Policy, we can be reached using the contact information on our “Contact Us” page or at support@multiply.club . In certain cases, you may have the ability to view or edit your personal information online. In the event your information is not accessible online, and you wish to obtain a copy of particular information you provided to Multiply, or if you become aware the information is incorrect and you would like us to correct it, please contact us immediately.",
            "Before Multiply is able to provide you with any information or correct any inaccuracies, however, we may ask you to verify your identity and to provide other details to help us to respond to your request. We will contact you within 30 days of your request."
        ]
    }
];
const Policies = () => {
