        ...
        <div className='min-h-screen px-5 '>
            <div className='max-w-5xl mx-auto pt-40'>
                ...
                <div className='space-y-10 text-primary pb-10'>
                    <p>Welcome to www.Point Up.club(“Website”) owned and operated by Compounding Happiness Private Limited (‘’Point Up’’), a company incorporated under the provisions of the Companies Act, 1956 and having its registered office at Gali No. 9, RZ-372, D Block, Prem Nagar, Najafgarh New Delhi - 110043.</p>
